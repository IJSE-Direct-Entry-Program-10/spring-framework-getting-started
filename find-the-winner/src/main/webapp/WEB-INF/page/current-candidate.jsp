...
<body>
    ...
    <main>
        <section>
            <img src="https://www.goodmorningimagesdownload.com/wp-content/uploads/2021/12/Best-Quality-Profile-Images-Pic-Download-2023.jpg" alt="profile">
            <h2>Rashmitha Piyushan</h2>
            <h3>John</h3>
            <h3>Selected Date: 2023-May-09</h3>
            <form action="#">
